...
function HomePage() {
  ...
  return (
    ...
    <h2 className=' after1100:text-3xl after1100:leading-snug'>Thanks for exploring <span className='firstLine'></span></h2>
     ...
     <img className='image' src='https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=1931&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'/>
